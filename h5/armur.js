...
var END_ARM_HEIGHT   = 2.5;
var END_ARM_WIDTH    = 0.5;
...
function endArm()
{
    var s = scalem(END_ARM_WIDTH, END_ARM_HEIGHT, END_ARM_WIDTH);
    var instanceMatrix = mult(translate( 0.0, 0.5 * END_ARM_HEIGHT, 0.0 ),s);    
    var t = mult(modelViewMatrix, instanceMatrix);
    gl.uniformMatrix4fv( modelViewMatrixLoc,  false, flatten(t) );
    gl.drawArrays( gl.TRIANGLES, 0, NumVertices );
}
...
var render = function() {
    ...
    modelViewMatrix  = mult(modelViewMatrix, rotateZ( theta[EndArm] ) );
    endArm();
